...
title: "Using Quantmental Approach to Constructing Portfolios"
...
keywords: "K-Means Clustering \\sep Price Volatility \\sep Value" # Use \\sep to separate
...
```{r Figure2, warning =  FALSE, fig.align = 'center', fig.cap = "Caption Here \\label{Figure2}", fig.height = 3, fig.width = 6, ticks = 'Tikz'}
