...
\title{Using Quantmental Approach to Constructing Portfolios}
...
\begin{keyword}
\footnotesize{
K-Means Clustering \sep Price Volatility \sep Value \\
\vspace{0.3cm}
}
\footnotesize{
...
{\centering \includegraphics{Using-macro-factor-models-to-build-thematic-portfolios_files/figure-latex/Figure1-1} 
...
{\centering \includegraphics{Using-macro-factor-models-to-build-thematic-portfolios_files/figure-latex/Figure2-1} 
